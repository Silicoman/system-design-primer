...
> Apprendre comment concevoir des systèmes à grande échelle.
>
> Se préparer pour des entretiens sur la conception de système.

### Apprendre comment concevoir des systèmes à grande échelle.

Apprendre comment concevoir des systèmes évolutifs vous aideront à devenir un(e) meilleur(e) ingénieur(e).

La conception des systèmes est un large sujet. Il y a une **vaste montagne de ressources disséminées sur le web** sur les principes de conception des systèmes.

Ce dépôt est une **collection organisée** de ces ressources pour vous aider à apprendre comment construire des systèmes évolutifs.

### Apprendre de la communauté OpenSource

Il s'agit d'un projet open source continuellement mis à jour.

[Les contributions](#contributing) sont bienvenues!

### Se préparer pour des entretiens sur la conception de système

En complément des entretiens de code, la conception des systèmes est
une **compétence obligatoire** évaluée lors du **processus d'entretien technique** dans la plupart des entreprises technologiques.   

**S'entraîner sur des questions d'entretiens des schémas classiques de conception de système** et **comparer** ses résultats avec des **exemples de solution**: discussions, code et diagrammes.
